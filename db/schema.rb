...
ActiveRecord::Schema.define(version: 20150920162455) do
  ...
  add_index "has_categories", ["item_id"], name: "index_has_categories_on_item_id", using: :btree
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at",                                      null: false
    t.datetime "updated_at",                                      null: false
    t.integer  "admin_permission",       limit: 4,   default: 0
  ...
  add_foreign_key "has_categories", "items"
